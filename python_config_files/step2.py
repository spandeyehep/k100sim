...
parser.add_option("-f", "--inFileName", dest="inFileName",action="store",
                      help="k100sim step1 root file path",default="inin.root")
...
x = tree_k100['X1'].array(library="np") 
y = tree_k100['Y1'].array(library="np") 
z = tree_k100['Z1'].array(library="np") 
pdgid = tree_k100['Type'].array(library="np")
nCap = tree_k100['nCap'].array(library="np") 
Edep = tree_k100['D3'].array(library="np") 

neutron_capture_events = helper.GetNcapEvents(nCap)
