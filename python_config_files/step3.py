...
parser.add_option("-f", "--inFileName", dest="inFileName",action="store",
                      help="Only neutron capture k100sim and nrCascadeSim step2 root file",default="inin.root")
...
basedir_geant4 = "/Users/shubhampandey/work/geant4/k100sim_anthony/k100Sim_ROOT_OUT_combined_stepping_action/build_after_mac_update"
